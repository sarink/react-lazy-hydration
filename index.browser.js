...
var LazyHydrate = function LazyHydrate(props) {
  ...
  var noWrapper = props.noWrapper,
    ...
    rest = _objectWithoutPropertiesLoose__default["default"](props, [
      "noWrapper",
      "ssrOnly",
      "whenIdle",
      "whenVisible",
  ...
  useIsomorphicLayoutEffect(function() {
    ...
    // No SSR Content
    if (
      !((_childRef$current = childRef.current) == null
        ? void 0
        : _childRef$current.hasChildNodes())
    ) {
      setHydrated(true);
    }
  }, []);
  React.useEffect(
    function() {
      ...
      if (whenVisible) {
        ...
        if (
          io &&
          ((_childRef$current2 = childRef.current) == null
            ? void 0
            : _childRef$current2.childElementCount)
        ) {
