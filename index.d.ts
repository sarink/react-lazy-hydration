...
export declare type LazyProps = {
    ...
    listenOnEl?: HTMLElementTagNameMap[keyof HTMLElementTagNameMap] | HTMLDocument | Window;
};
declare type Props = Omit<React.HTMLProps<HTMLDivElement>, "dangerouslySetInnerHTML"> & LazyProps;
